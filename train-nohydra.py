...
class LightningModel(pl.LightningModule):
    ...
    def configure_optimizers(self):
        optimizer = optim.Adam(self.model.parameters(), lr=self.lr, weight_decay=self.weight_decay) # , momentum=self.momentum)
...
def parse_args():
    ...
    parser.add_argument('--train-base-dir', '-d', default='/home/jungin500/Workspace/mobilenetv2/outputs')
